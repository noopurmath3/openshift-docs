...
. Punch the files to the virtual reader of your bootstrap machine
+
[TIP]
====
You can use the CP PUNCH command or, if you use Linux, the **vmur** command to transfer files between two z/VM gust virtual machines.
====
+
