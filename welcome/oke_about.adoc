...
| Red Hat Enterprise Linux (RHEL) or CoreOS entitlement | Included | Included | N/A
| Existing RHEL manual attach to cluster (BYO) | Included | Included | N/A
| CRIO Runtime | Included | Included | N/A
| Over the Air Smart Upgrades and Operating System (CoreOS) Management | Included | Included | N/A
...
| Red Hat OpenShift Jaeger | Not Included | Included | Jaeger Operator
