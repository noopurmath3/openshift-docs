...
Before you install a cluster in a restricted network, you must mirror the required container images into that environment. A restricted network might be one with limited network connectivity or a completely disconnected or airgapped installation. You can also use this procedure in unrestricted networks to ensure your clusters only use container images that have satisfied your organizational controls on external content.
