...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#machineconfiglist-machineconfiguration-openshift-io-v1[`MachineConfigList machineconfiguration.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../machine_apis/machineconfig-machineconfiguration-openshift-io-v1.adoc#machineconfig-machineconfiguration-openshift-io-v1[`MachineConfig machineconfiguration.openshift.io/v1`]
| 
|===
