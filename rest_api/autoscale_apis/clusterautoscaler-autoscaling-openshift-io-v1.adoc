...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#clusterautoscalerlist-autoscaling-openshift-io-v1[`ClusterAutoscalerList autoscaling.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../autoscale_apis/clusterautoscaler-autoscaling-openshift-io-v1.adoc#clusterautoscaler-autoscaling-openshift-io-v1[`ClusterAutoscaler autoscaling.openshift.io/v1`]
| 
|===
