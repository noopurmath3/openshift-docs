...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#consolenotificationlist-console-openshift-io-v1[`ConsoleNotificationList console.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../console_apis/consolenotification-console-openshift-io-v1.adoc#consolenotification-console-openshift-io-v1[`ConsoleNotification console.openshift.io/v1`]
| 
|===
