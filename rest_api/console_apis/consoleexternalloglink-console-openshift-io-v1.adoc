...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#consoleexternalloglinklist-console-openshift-io-v1[`ConsoleExternalLogLinkList console.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../console_apis/consoleexternalloglink-console-openshift-io-v1.adoc#consoleexternalloglink-console-openshift-io-v1[`ConsoleExternalLogLink console.openshift.io/v1`]
| 
|===
