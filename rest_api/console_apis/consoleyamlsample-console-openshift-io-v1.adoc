...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#consoleyamlsamplelist-console-openshift-io-v1[`ConsoleYAMLSampleList console.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../console_apis/consoleyamlsample-console-openshift-io-v1.adoc#consoleyamlsample-console-openshift-io-v1[`ConsoleYAMLSample console.openshift.io/v1`]
| 
|===
