...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#operatorlist-operators-coreos-com-v1[`OperatorList operators.coreos.com/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operatorhub_apis/operator-operators-coreos-com-v1.adoc#operator-operators-coreos-com-v1[`Operator operators.coreos.com/v1`]
| 
|===
