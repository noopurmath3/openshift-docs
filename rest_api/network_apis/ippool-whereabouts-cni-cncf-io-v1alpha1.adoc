...
| 200 - OK
| xref:../objects/index.adoc#ippoollist-whereabouts-cni-cncf-io-v1alpha1[`IPPoolList whereabouts.cni.cncf.io/v1alpha1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../network_apis/ippool-whereabouts-cni-cncf-io-v1alpha1.adoc#ippool-whereabouts-cni-cncf-io-v1alpha1[`IPPool whereabouts.cni.cncf.io/v1alpha1`]
| 
|===
