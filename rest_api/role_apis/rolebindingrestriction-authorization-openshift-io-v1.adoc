...
| Parameter | Type | Description
| `body`
| xref:../role_apis/rolebindingrestriction-authorization-openshift-io-v1.adoc#rolebindingrestriction-authorization-openshift-io-v1[`RoleBindingRestriction authorization.openshift.io/v1`]
| 
|===
