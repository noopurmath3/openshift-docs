...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#clusterrolebindinglist-rbac-authorization-k8s-io-v1[`ClusterRoleBindingList rbac.authorization.k8s.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../rbac_apis/clusterrolebinding-rbac-authorization-k8s-io-v1.adoc#clusterrolebinding-rbac-authorization-k8s-io-v1[`ClusterRoleBinding rbac.authorization.k8s.io/v1`]
| 
|===
