...
| Parameter | Type | Description
| `body`
| xref:../authorization_apis/localresourceaccessreview-authorization-openshift-io-v1.adoc#localresourceaccessreview-authorization-openshift-io-v1[`LocalResourceAccessReview authorization.openshift.io/v1`]
| 
|===
