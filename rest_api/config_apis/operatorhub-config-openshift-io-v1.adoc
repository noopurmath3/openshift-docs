...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#operatorhublist-config-openshift-io-v1[`OperatorHubList config.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../config_apis/operatorhub-config-openshift-io-v1.adoc#operatorhub-config-openshift-io-v1[`OperatorHub config.openshift.io/v1`]
| 
|===
