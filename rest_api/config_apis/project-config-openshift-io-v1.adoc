...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#projectlist-config-openshift-io-v1[`ProjectList config.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../config_apis/project-config-openshift-io-v1.adoc#project-config-openshift-io-v1[`Project config.openshift.io/v1`]
| 
|===
