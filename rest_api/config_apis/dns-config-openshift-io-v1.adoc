...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#dnslist-config-openshift-io-v1[`DNSList config.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../config_apis/dns-config-openshift-io-v1.adoc#dns-config-openshift-io-v1[`DNS config.openshift.io/v1`]
| 
|===
