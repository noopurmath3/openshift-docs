...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#consolelist-config-openshift-io-v1[`ConsoleList config.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../config_apis/console-config-openshift-io-v1.adoc#console-config-openshift-io-v1[`Console config.openshift.io/v1`]
| 
|===
