...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#storagestatelist-migration-k8s-io-v1alpha1[`StorageStateList migration.k8s.io/v1alpha1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_apis/storagestate-migration-k8s-io-v1alpha1.adoc#storagestate-migration-k8s-io-v1alpha1[`StorageState migration.k8s.io/v1alpha1`]
| 
|===
