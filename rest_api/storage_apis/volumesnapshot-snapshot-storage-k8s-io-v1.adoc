...
| 200 - OK
| xref:../objects/index.adoc#volumesnapshotlist-snapshot-storage-k8s-io-v1[`VolumeSnapshotList snapshot.storage.k8s.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_apis/volumesnapshot-snapshot-storage-k8s-io-v1.adoc#volumesnapshot-snapshot-storage-k8s-io-v1[`VolumeSnapshot snapshot.storage.k8s.io/v1`]
| 
|===
