...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#storageversionmigrationlist-migration-k8s-io-v1alpha1[`StorageVersionMigrationList migration.k8s.io/v1alpha1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_apis/storageversionmigration-migration-k8s-io-v1alpha1.adoc#storageversionmigration-migration-k8s-io-v1alpha1[`StorageVersionMigration migration.k8s.io/v1alpha1`]
| 
|===
