...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#kubestorageversionmigratorlist-operator-openshift-io-v1[`KubeStorageVersionMigratorList operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/kubestorageversionmigrator-operator-openshift-io-v1.adoc#kubestorageversionmigrator-operator-openshift-io-v1[`KubeStorageVersionMigrator operator.openshift.io/v1`]
| 
|===
