...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#configlist-operator-openshift-io-v1[`ConfigList operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/config-operator-openshift-io-v1.adoc#config-operator-openshift-io-v1[`Config operator.openshift.io/v1`]
| 
|===
