...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#imagecontentsourcepolicylist-operator-openshift-io-v1alpha1[`ImageContentSourcePolicyList operator.openshift.io/v1alpha1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/imagecontentsourcepolicy-operator-openshift-io-v1alpha1.adoc#imagecontentsourcepolicy-operator-openshift-io-v1alpha1[`ImageContentSourcePolicy operator.openshift.io/v1alpha1`]
| 
|===
