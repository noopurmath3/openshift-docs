...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#kubecontrollermanagerlist-operator-openshift-io-v1[`KubeControllerManagerList operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/kubecontrollermanager-operator-openshift-io-v1.adoc#kubecontrollermanager-operator-openshift-io-v1[`KubeControllerManager operator.openshift.io/v1`]
| 
|===
