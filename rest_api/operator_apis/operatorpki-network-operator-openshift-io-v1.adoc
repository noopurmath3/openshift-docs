...
| 200 - OK
| xref:../objects/index.adoc#operatorpkilist-network-operator-openshift-io-v1[`OperatorPKIList network.operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/operatorpki-network-operator-openshift-io-v1.adoc#operatorpki-network-operator-openshift-io-v1[`OperatorPKI network.operator.openshift.io/v1`]
| 
|===
