...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#servicecalist-operator-openshift-io-v1[`ServiceCAList operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/serviceca-operator-openshift-io-v1.adoc#serviceca-operator-openshift-io-v1[`ServiceCA operator.openshift.io/v1`]
| 
|===
