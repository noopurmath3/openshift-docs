...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#runtimeclasslist-node-k8s-io-v1[`RuntimeClassList node.k8s.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../node_apis/runtimeclass-node-k8s-io-v1.adoc#runtimeclass-node-k8s-io-v1[`RuntimeClass node.k8s.io/v1`]
| 
|===
